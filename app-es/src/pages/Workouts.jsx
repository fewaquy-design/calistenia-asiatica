  ...
  return (
    <div className="flex flex-col min-h-screen pb-6 bg-[#FAFAFA]">
      <div className="px-6 pt-10 pb-6">
        ...
        <p className="text-sm text-gray-500 mb-6">Programa completo de 21 días</p>
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <div>
                          ...
                          <h4 className="font-bold text-gray-800 text-lg">Día {day.id}</h4>
                        </div>
                        ...
                        {isHoje ? (
                          ...
                          <Link to={`/workout/${day.id}`} className="text-gray-500 border border-gray-200 px-4 py-2 rounded-full text-xs font-medium flex items-center gap-1">
                            {isConcluido ? 'Rehacer' : 'Ver'} <Play size={12} />
                          </Link>
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-500 mt-2">
                        ...
                        <div className="flex items-center gap-1">
                          <Flame size={12} /> {day.exercisesCount} ejercicios
                        </div>
                      </div>
                    </div>
                  );
