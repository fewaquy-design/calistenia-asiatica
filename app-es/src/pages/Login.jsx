  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12">
      ...
      <div className="w-full bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <h2 className="text-[15px] font-bold text-center mb-6 text-gray-800">Iniciar Sesión</h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 mb-1">¿Aún no tienes cuenta?</p>
          <Link to="/register" className="text-sm text-primary font-medium hover:underline">Crear cuenta</Link>
        </div>
      </div>

      <div className="mt-8 text-center px-4">
        <p className="text-[10px] text-gray-400 leading-tight">
          Al continuar, aceptas nuestros Términos de Uso<br/>y Política de Privacidad.
        </p>
      </div>
    </div>
  );
