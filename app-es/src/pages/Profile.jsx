...
export default function Profile() {
  ...
  const handleReset = () => {
    if(window.confirm('¿Estás segura de que deseas resetear tu progreso?')) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fafafa] pb-24 px-6 pt-6">
      <div className="mb-6">
        ...
        <p className="text-[11px] text-gray-500">Tu información y configuraciones</p>
      </div>
      ...
      <div className="bg-white rounded-[1.5rem] p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-100 mb-4">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <button className="text-[12px] text-[#cf5c76] font-medium mt-0.5">Editar nombre</button>
          </div>
        </div>
        ...
        <div className="flex justify-between items-end px-2">
          <div className="flex flex-col items-center">
            ...
            <span className="text-[12px] text-gray-500">Progreso</span>
          </div>
          
          <div className="flex flex-col items-center">
            <span className="text-[26px] font-bold text-gray-900 leading-none mb-1">0</span>
            <span className="text-[12px] text-gray-500">Entrenam.</span>
          </div>
      ...
      <button className="w-full bg-white rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-100 mb-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h3 className="text-[14px] font-bold text-gray-900">Preferencias</h3>
            <p className="text-[12px] text-gray-500">Configura tu app</p>
          </div>
        </div>
