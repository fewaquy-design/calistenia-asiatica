  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-8">
      ...
      <div className="w-full bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <h2 className="text-xl font-bold text-center mb-2 text-gray-800">Antes de comenzar...</h2>
        ...
        <form onSubmit={handleStart}>
          ...
          <div className="mb-4">
            <label className="block text-xs font-medium text-gray-700 mb-1">Peso Actual (kg)</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
      ...
      <div className="mt-6 text-center px-4">
        <p className="text-[11px] text-gray-400 leading-tight max-w-[250px] mx-auto">
          Estos datos se usarán para personalizar tus entrenamientos y dieta
        </p>
      </div>
    </div>
  );
